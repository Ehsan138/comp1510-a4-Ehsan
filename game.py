...
def fixed_battles(challenge_name, character):
    ...
    # #     print(data[challenge_name]["is_not_ready"])
    # elif challenge_name == 'battle_five' and will_battle == "1" and character["battle_five"] == 0:
    #     print(data[challenge_name]["is_not_ready"])
    # elif challenge_name == 'battle_six' and will_battle == "1" and (character["battle_four"] == 0 or
    #                                                                 character["battle_five"] == 0):
    #     print(data[challenge_name]["is_not_ready"])
    # else:
    #     character["Experience_Points"] -= 50
    #     print("You lose 50 EXP Points for fleeing from battle.")
